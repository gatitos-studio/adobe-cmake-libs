...
namespace ai
{
    ...
    AIErr ArtboardProperties::GetRulerOriginAbsolute(AIRealPoint& rulerOrigin) const
    {
        return sAIArtboard->GetRulerOriginAbsolute(*this,rulerOrigin);
    }
    AIErr ArtboardProperties::SetRulerOriginAbsolute(const AIRealPoint& rulerOrigin)
    {
        return sAIArtboard->SetRulerOriginAbsolute(*this,rulerOrigin);
    }
#endif
